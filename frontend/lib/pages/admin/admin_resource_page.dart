  ...
  Future<void> _deleteResource(ResourceModel resource) async {
    final confirm = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: const Text('Hapus Resource', style: TextStyle(color: kErrorColor, fontFamily: kFontFamily)),
        content: Text(
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    resource.type,
                                    style: const TextStyle(color: kAccentColor, fontSize: 11, fontFamily: kFontFamily),
                                  ),
                                  ...
                                  Row(
                                    children: [
                                      Text(
                                        ...
                                        style: const TextStyle(color: kGoldColor, fontFamily: kFontFamily, fontSize: 13, fontWeight: FontWeight.w700),
                                      ),
                                ...
                                IconButton(
                                  ...
                                  onPressed: () async {
                                    await Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (_) => AdminFormPage(resourceToEdit: resource),
                                      ),
                                    );
                                    _loadResources();
                                  },
